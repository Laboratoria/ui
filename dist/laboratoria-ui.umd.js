(function (global, factory) {
	...
	*/
	...
	var CardMedia$1 = createCommonjsModule(function (module, exports) {
	...
	var _CardMedia = interopRequireDefault(CardMedia_1);
	});

	var CardMedia$2 = unwrapExports(CardMedia$1);
	...
	var CardMediaGitHub = function CardMediaGitHub(props) {
	  ...
	  return React.createElement(Card$2, {
	  ...
	  }, React.createElement(CardMedia$2, {
	    className: classes.thumbnail,
	    image: "https://github.com/" + data.github + ".png?size=300",
	    title: data.name
	  }, React.createElement("img", {
	    src: Flags[data.campus],
	    alt: data.campus,
	    ...
	    component: "h2",
	    gutterBottom: true
	  }, data.name), React.createElement(Typography$2, {
	    paragraph: true,
	    classes: {
	      paragraph: classes.paragraph
	    }
	  }, data.recomendedAs)), React.createElement(CardActions$2, {
	...
	exports.Theme = theme;
	exports.Buttons = PrimaryButton$1;
